...
Start-Process -FilePath "C:\Windows\System32\cmd.exe" -ArgumentList {/c $TempLevainDir\levain.cmd install --addRepo https://github.com/jmoalves/levain-pkgs.git install levain}

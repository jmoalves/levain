...
%PWS% Invoke-WebRequest %proxyCfg% "https://github.com/denoland/deno/releases/download/v%2/deno-x86_64-pc-windows-msvc.zip" -OutFile %tempPath%\deno-x86_64-pc-windows-msvc.zip
%PWS% Expand-Archive %tempPath%\deno-x86_64-pc-windows-msvc.zip -DestinationPath %denoDST% -Force
rmdir /q /s %tempPath%

echo === Deno for Windows at %denoDST%
%denoDST%\deno -V info

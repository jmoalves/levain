...
Deno.test('VersionNumber - invalid version numbers', () => {
...
Deno.test('VersionNumber - components - 1.0.0', () => {
    const str = "1.0.0"
    assertEquals(versionNumber(str).version, str)
    assertEquals(versionNumber(str).major, 1)
    assertEquals(versionNumber(str).minor, 0)
    assertEquals(versionNumber(str).patch, 0)
    assertEquals(versionNumber(str).prerelease, undefined)
    assertEquals(versionNumber(str).build, undefined)
})

Deno.test('VersionNumber - components - 1.0.0-20210228-151400-some-other-text', () => {
    const str = "1.0.0-20210228-151400-some-other-text"
    assertEquals(versionNumber(str).version, str)
    assertEquals(versionNumber(str).major, 1)
    assertEquals(versionNumber(str).minor, 0)
    assertEquals(versionNumber(str).patch, 0)
    assertEquals(versionNumber(str).prerelease, "20210228-151400-some-other-text")
    assertEquals(versionNumber(str).build, undefined)
})
...
Deno.test('VersionNumber - components - 1.0.0-20210228-151400-some-other-text+1.0.0-332', () => {
    const str = "1.0.0-20210228-151400-some-other-text+1.0.0-332"
    assertEquals(versionNumber(str).version, str)
    assertEquals(versionNumber(str).major, 1)
    assertEquals(versionNumber(str).minor, 0)
    assertEquals(versionNumber(str).patch, 0)
    assertEquals(versionNumber(str).prerelease, "20210228-151400-some-other-text")
    assertEquals(versionNumber(str).build, "1.0.0-332")
})
...
Deno.test('VersionNumber - compare', () => {
    ...
    assertEquals(versionNumber("10.0.1+21098").compareTo(versionNumber("10.0.1+386")), VersionNumber.SAME)
    ...
    assertEquals(versionNumber("10.0.1-beta.2+2398").compareTo(versionNumber("10.0.1-beta.2+3252")), VersionNumber.SAME)

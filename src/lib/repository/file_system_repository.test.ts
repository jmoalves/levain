import { assert, assertEquals, assertMatch, assertNotEquals, assertRejects } from "https://deno.land/std/assert/mod.ts";
...
function getRepo(
  rootDir: string = "./testdata/file_system_repo/testRepo",
